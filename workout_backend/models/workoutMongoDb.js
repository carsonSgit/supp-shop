...
async function addUser(username, email, password) {
	...
	try {
		...
		throw new DatabaseError(
			"Error inserting user into database: " + err.message,
		);
	}
}
...
async function getSingleUser(username) {
	...
	try {
		...
		logger.error(err.message);
		throw new DatabaseError(
			"Error getting user " + username + "from database: " + err.message,
		);
	}
...
async function getAllUsers() {
	...
	try {
		...
		logger.error(err.message);
		throw new DatabaseError(
			"Error getting all users from database: " + err.message,
		);
	}
...
async function deleteSingleUser(username) {
	...
	try {
		...
		logger.error(err.message);
		throw new DatabaseError(
			"Error deleting user " + username + "from database: " + err.message,
		);
	}
...
async function updateSingleUser(username, newUsername, email, password) {
	...
	try {
		...
		logger.error(err.message);
		throw new DatabaseError(
			"Error updating user " + username + " in database: " + err.message,
		);
	}
...
async function getSingleProduct(flavour) {
	try {
		...
		throw new DatabaseError(
			"Error: Execution of findOne() resulted in an error",
		);
	}
}
...
async function getUserCollection() {
	if (usersCollection != null) return usersCollection;
}
...
async function getProductsCollection() {
	if (productsCollection != null) return productsCollection;
}
...
async function getOrdersCollection() {
	if (ordersCollection != null) return ordersCollection;
}
